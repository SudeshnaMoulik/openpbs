...
static PyNumberMethods pps_size_as_number = {
	...
	/* nb_multiply */                   0,
	/* nb_divide -  not part of PyNumberMethods in Python3*/
	/* nb_remainder */                  0,
	/* nb_divmod */                     0,
	/* nb_power */                      0,
	/* nb_negative */                   0,
	...
	/* nb_nonzero - not a part of Python3 */
	...
	/* nb_xor */                        0,
	/* nb_or */                         0,
	/* nb_coerce is not  present in Python3 */
	...
	/* nb_long - not a part of Python3*/
	/* nb_float */                      0,
	/* nb_oct - not a part of Python3*/
	/* nb_hex - not a part of Python3*/
	/* nb_inplace_add */                0,
	/* nb_inplace_subtract */           0,
	/* nb_inplace_multiply */           0,
	/* nb_inplace_divide - not a part of Python3*/
...
PyTypeObject PPSVR_Size_Type = {
	...
	/* tp_getattr*/                     0,
	/* tp_setattr*/                     0,
	/* tp_compare not a part of python3 - https://docs.python.org/3.6/c-api/typeobj.html#c.PyNumberMethods* */
	/* tp_as_async */		    0,
